...
opts_chunk$set(fig.path='./knitr-figs/lecture04-',echo=FALSE, cache=TRUE,results='hide', warning=FALSE, fig.width=8,fig.height=4.5,size='scriptsize',error=FALSE,tidy=FALSE)
...
###
### Description:
###  Rnw File for lecture 04
###
### History:
###  -- 2021-03-10 modified as part of STA427
###  -- 2020-06-27 file created as part of lecture 06 of SmitSjuk
######################################################################
